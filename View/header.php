...
<html lang="es">
  ...
  <!---Internet --->
    ...
    <body class="b1">
      <!--- Barra de inicio --->
<nav class="navbar navbar-inverse" style="background: linear-gradient(to right, #000066 0%, #3366ff 100%);" style="color: white;">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">MagicSoft</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="?z=Inicio" onclick="popy()">Inicio</a></li>
        <li><a href="?p=proyectos">Proyectos</a></li>
        <li><a href="?c=Usuario">Usuarios</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><button id="logs"><a href="?l=login"><span class="glyphicon glyphicon-log-in"></span> Login</button></a></li>
      </ul>
    </div>
  </div>
</nav>
